    ...
    try {
      ...
      if (result.error || !result.data) {
        ...
        const demoComponents: ComponentItem[] = [
          ...
          { id: 'comp-3', name: 'MetricCard', type: 'ui', category: 'Data Display', filePath: 'src/components/MetricCard.tsx', status: 'working', description: 'KPI metric kaart met trend indicator', dependencies: [], dependents: ['CRMPage', 'EscalDashboard'], props: ['title', 'value', 'trend', 'icon'], tokens: ['colors.indigo'], lastModified: '2026-02-06' },
          { id: 'comp-4', name: 'EventTable', type: 'feature', category: 'Escal', filePath: 'src/components/escal/EventTable.tsx', status: 'working', description: 'Sorteerbare en filterbare event tabel', dependencies: ['Table', 'Badge', 'Pagination'], dependents: ['EventsPage'], props: ['events', 'onFilter'], tokens: [], lastModified: '2026-02-08' },
          ...
          { id: 'comp-7', name: 'LiveMap', type: 'feature', category: 'Escal', filePath: 'src/components/escal/LiveMap.tsx', status: 'planned', description: 'Google Maps integratie voor live gebruikers', dependencies: [], dependents: ['LivePage'], props: ['locations'], tokens: [], lastModified: '2026-02-03' },
